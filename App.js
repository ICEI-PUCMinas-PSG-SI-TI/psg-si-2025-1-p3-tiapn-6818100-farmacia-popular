...
function Inicial() {
  ...
  function handleCardClick(label) {
    if (label === 'Usuários') {
      ...
      navigate('/produtos');
    } else if (label === 'Cadastro de Produto') {
      navigate('/cadastro-produto');
    }
    // Pode adicionar navegação para outras telas conforme necessidade
  }
...
const cards = [
  ...
  {
    img: 'https://img.icons8.com/ios-filled/100/000000/plus-math.png',
